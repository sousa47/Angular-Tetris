  ...
  private static checkCollisionAt90Degrees(
    ...
    try {
      switch (direction) {
        case 'down':
          return (
            currentBoard[x + 2][y + 1] === 1 || currentBoard[x + 3][y] === 1
          );
        case 'left':
          return (
            currentBoard[x][y - 1] === 1 ||
  ...
  private static checkCollisionAt180Degrees(
    ...
    try {
      switch (direction) {
        ...
        case 'left':
          return currentBoard[x][y - 1] === 1 || currentBoard[x + 1][y] === 1;
        case 'right':
          return (
            currentBoard[x][y + 3] === 1 || currentBoard[x + 1][y + 2] === 1
          );
      }
    } catch {
      return true;
